...
export function BarDetailScreen() {
  ...
  const queueStatus = bar.waitTime < 10 ? 'fast' : bar.waitTime > 25 ? 'saturated' : null;
    ...
    <div className="min-h-screen bg-gray-50 pb-28">
      <div className="relative h-64">
        ...
        <div className="absolute top-4 right-4 flex gap-2">
          {bar.hasOffer && <StatusBadge type="offer" />}
      ...
      <div className="bg-white rounded-t-3xl -mt-6 relative z-10 p-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold mb-1">{bar.name}</h1>
            <p className="text-gray-600">{bar.type}</p>
          </div>
          <div className={`px-3 py-1 rounded-full text-sm font-medium ${bar.isOpen ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
        ...
        <div className="flex items-center gap-4 mb-4">
          <div className="flex items-center gap-2 text-gray-700">
            ...
            <span>{bar.waitTime} min wait</span>
          </div>
        </div>
        ...
        {bar.hasOffer && (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-purple-700">View Special Offers</span>
            </div>
